...
💡 This plugin can roughly provide the following features (an overview impression; detailed usage is covered in the corresponding pages of the documentation site).
