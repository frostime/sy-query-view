...
**当前状态：** 文档结构、人类文档和 GUI 代码结构均已验收；文档站 GUI 正在实现。
**当前前沿：** “开发文档站 GUI”正在执行。
...
| 开发文档站 GUI | 在已验收的代码结构上用原生 TypeScript/DOM 实现桌面文档站，使用 Lute、SiYuan CSS class/变量，具备侧边栏、页面导航、语言选择和复制操作。 | 已验收的 GUI 代码结构。 | 执行中；见 `nodes/build-docs-gui/` |
...
当前执行任务：`nodes/build-docs-gui/TASK-NODE.SPEC.md`。
